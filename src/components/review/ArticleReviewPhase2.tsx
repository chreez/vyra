import { Container, Title, Text, Textarea, Button, Image, Stack, Badge, Paper } from '@mantine/core';
...
import { Review1Data } from './ArticleReviewPhase1';

interface ArticleReviewPhase2Props {
  slug: string;
  review1Data: Review1Data;
  onBack: () => void;
}

export function ArticleReviewPhase2({ review1Data, onBack }: ArticleReviewPhase2Props) {
  ...
  // Filter sections to show only those with selected images from review1Data
  const sectionsToDisplay = article.sections.map((section, idx) => {
    const selectedImage = review1Data.sectionImageSelections[idx.toString()];
    return {
      ...section,
      selectedImage: selectedImage && selectedImage !== 'none' ? selectedImage : null,
    };
  });
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.articleColumn}>
          <Container size="md" className={styles.articleContainer}>
            ...
            {/* Hero Image - Use selected image from Review 1 */}
            <Image
